...
export class Achievement {
    ...
    private static readonly STORAGE_KEY = "tankGame_militaryRank12";
    ...
    public getCurrentRankInfo_junxian(): { rank: MilitaryRank, natoCode: string, soldiers: number, nextRank?: RankConfig } {
